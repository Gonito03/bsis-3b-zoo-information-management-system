            ...
            <div>
                ...
                <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
                    ...
                    <div class="py-5">
                        ...
                        <div class="mt-5">
                            <!-- Star -->
                            <svg class="h-auto w-16 text-foreground" width="110" height="28" viewBox="0 0 110 28"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <div class="relative">
                            ...
                            <div class="pt-4">
                                ...
                                <p class="gap mt-2 font-semibold text-foreground">
                                    ...
                                    {{ Str::ucfirst($animal->gender) ?? $animal->gender }} | {{ $animal->year_age }} Yr/s |
                                    {{ $animal->month_age }} Mth/s
                                </p>
                            </div>
